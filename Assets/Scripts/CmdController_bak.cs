...
public class CmdController_bak : MonoBehaviour
{
    public Main main;
    ...
    // Add by Ray
    // private Dictionary<string, Action> funcDict;
    // private CmdFunction cmdFunction;
    public float recognizeTime = 0.5f;
    ...
    // void CreateFuncDict()
    // {
    //     // create Dict<string, Action> for the alpha function
    //     funcDict = new Dictionary<string, Action>();

    //     int i = 0;
    //     foreach (KeyValuePair<string, string> kvp in alphaDict)
    //     {
    //         funcDict.Add(kvp.Value, cmdFunction.functions[i]);
    //         Debug.Log(cmdFunction.functions.Count);
    //         i++;
    //     }
    // }
